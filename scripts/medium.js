...
function chooseDefender() {
    ...
    ctx.drawImage(defender4, 0, 0, 160, 160, 190, 10, 80, 80);
...
class Enemy {
    constructor(verticalPosition){
        ...
        this.enemyType = enemyTypes[Math.floor(Math.random() * 2)];
        this.frameX = 0;
        this.frameY = 0;
        this.minFrame = 0;
        this.shootNow = false;
...
function handleResources(){
    if (frame % 750 === 0 && score < winningScore){
...
function handleGameStatus(){
    ...
    ctx.fillText('50', 220, 90);
    ctx.strokeText('50', 220, 90);
